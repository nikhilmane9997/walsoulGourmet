        ...
        <section>
          <div className="container">
            ...
            <div className="w3-container" style={{ marginBottom: "100px" }}>
              <h3 className="header-text">OVERVIEW</h3>
              <div className="terms-sec">
                <p>
                  This website is operated by Walsoul Consulting. Throughout the
                  site, the terms “we”, “us” and “our” refer to Walsoul Gourmet.
                  Walsoul Gourmet offers this website, including all
                  ...
                  <br />
                  Our store is hosted on Walsoul Consulting. They provide us
                  with the online e-commerce platform that allows us to sell our
                  products and services to you.
                </p>
              </div>
              <h3 className="header-text">ONLINE STORE TERMS</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">GENERAL CONDITIONS</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">OPTIONAL TOOLS</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">THIRD-PARTY LINKS</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">PERSONAL INFORMATION</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">PROHIBITED USES</h3>
              <div className="terms-sec">
                <p>
              ...
              <div className="terms-sec">
                <p>
                  ...
                  <br />
                  In no case shall Walsoul Gourmet, our directors, officers,
              ...
              <h3 className="header-text">INDEMNIFICATION</h3>
              <div className="terms-sec">
                <p>
                  You agree to indemnify, defend and hold harmless Walsoul
                  Gourmet and our parent, subsidiaries, affiliates, partners,
              ...
              <h3 className="header-text">SEVERABILITY</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">TERMINATION</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">ENTIRE AGREEMENT</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">GOVERNING LAW</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">CHANGES TO TERMS OF SERVICE</h3>
              <div className="terms-sec">
                <p>
              ...
              <h3 className="header-text">CONTACT INFORMATION</h3>
              <div className="terms-sec">
                <p>
                  Questions about the Terms of Service should be sent to us at
                  customerservice@walsoulgourmet.in
                </p>
              </div>
            </div>
          </div>
